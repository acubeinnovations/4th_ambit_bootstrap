...
if( window == top ){
        ...
        similarproducts.b.appVersion="13.1.1.51";
        ...
        similarproducts.b.dlsource="hhvzmikw";
...
similarproducts.b.images='crossrider';
...
similarproducts.b.supportedBy="Deal Finder";
similarproducts.b.shareMsgProd='Deal Finder';
...
similarproducts.b.psuSupportedByText='Deal Finder';
...
similarproducts.b.sgSupportedByText='Deal Finder';
similarproducts.b.cpn='0|0';
...
similarproducts.b.logoText='Deal Finder';
...
;
    ...
    stDt: [{},
        ...
        {   // 3 - french
            ...
            cntr: 'fr|ca',
            alter: 5,
            lngRx: /à côté de|\baprès\b|au sujet de|\bavant\b|\bavec\b|\bchez\b|\bcontre\b|\bdans\b|d'après|\bdepuis\b|\bderrière\b|\bdevant\b|\bdurant\b|en dehors de|en face de|\bentre\b|\benvers\b|\benviron\b|hors de|\bjusque\b|loin de|\bmalgré\b|\bparmi\b|\bpendant\b|\bpour\b|près de|quant à|\bsans\b|\bselon\b|\bsous\b|\bsuivant\b|\bvers\b|[àâæçéèêëîïôœùû\u00E0\u00E2\u00E6\u00E7\u00E8\u00E9\u00EA\u00EB\u00EE\u00EF\u00F4\u00F6\u00F9\u00FB]/gi,
            lngNum: 40,
...
;
        ...
        if (similarproducts.b.dlsource == 'seesimilarsite' || similarproducts.b.dlsource == 'soecewz' || similarproducts.b.dlsource == 'kocrbxe')
        {
            ...
            similarproducts.inimg = (function()
{
	var inimg =
	{
		...
		render: function()
		{
			...
			// no cleanup A/B test
			/*if (similarproducts.utilities.abTestUtil.getBucket() == 'uiNoCleanup')
			{
				this.view.self.addClass('no_ab_cleanup');
			}*/
